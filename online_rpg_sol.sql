...
INSERT INTO items VALUES (1, 'Databaser: Den kompletta boken', 495);
INSERT INTO items VALUES (2, 'Vorpal sword', 10000);
INSERT INTO items VALUES (3, 'Ugnsvantar', 999);

INSERT INTO equippable VALUES (1, 'weapon');
INSERT INTO equippable VALUES (2, 'weapon');
INSERT INTO equippable VALUES (3, 'gloves');

INSERT INTO players VALUES ('kristian', 100, 50000);
INSERT INTO players VALUES ('thomas', 2, 0);

INSERT INTO player_inventory VALUES ('kristian', 1);
INSERT INTO player_inventory VALUES ('kristian', 3);
INSERT INTO player_inventory VALUES ('thomas', 1);

INSERT INTO equipped VALUES ('kristian', 2, 'weapon');
INSERT INTO equipped VALUES ('thomas', 3, 'gloves');
...
-- Query 1
SELECT itemname 
  FROM player_inventory, items
  WHERE item = id AND player = 'kristian';
...
SELECT id, COUNT(player) AS owners 
  FROM items LEFT OUTER JOIN player_inventory ON item = id
  GROUP BY id;
...
-- 6
WITH Everything AS (
   SELECT item, player FROM player_inventory
   UNION ALL
...
SELECT * 
  FROM player_inventory, equippable 
  WHERE item = id AND player = 'thomas'
                  AND equipslot NOT IN 
                      (SELECT equipSlot FROM equipped WHERE player = 'thomas') 
                  ;
